...
We briefly examine the average of numerical features of Pokemons in each type and we present a sample plot.
...
```
By inspection, Pokemons from a certain types will have a significantly higher/lower average in some of the features such as weight and egg cycles. However, this is not the case in general, an example of such would be number of abilities.
...
knitr::include_graphics("C:/Users/Kkda/Desktop/Final Project/Figures/CV-Loss-vs-Alpha.png")
```
...
knitr::include_graphics("C:/Users/Kkda/Desktop/Final Project/Figures/CV-Error-vs-Alpha-5-fold.png")
```
\newpage

## Appendix 9: Confusion-Matrix
```{r, out.width = "500px", echo = F, fig.align='center'}
knitr::include_graphics("C:/Users/Kkda/Desktop/Final Project/Figures/Confusion-Matrix.png")
```
\newpage
